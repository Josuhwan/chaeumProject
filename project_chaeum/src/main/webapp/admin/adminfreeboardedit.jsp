	...
	<div class="row" align="center" style="display: block;">
		<div class="col-lg-3 grid-margin stretch-card">
			<div class="card position-relative">
				<div class="card-body">
					<h4 class="card-title" style="margin-bottom: 30px;">자유게시판 게시글 수정</h4>
					<form action="adminfreeboardedit.do" method="get">
						<input type="hidden" name="board_id" value="${onefreeboard.board_id }">
						<table class="table-vertical" style="text-align: left;">
							<tr>
								<th>제목</th>
								<td colspan="2"><input type="text" name="title" value="${onefreeboard.title }"></td>
							</tr>
							<tr>
								<th>작성자</th>
								<td colspan="2">${onefreeboard.nickname }</td>
							</tr>
							<tr>
								<th>내용</th>
								<td colspan="2"><input type="text" name="b_contents" value="${onefreeboard.b_contents }"></td>
							</tr>
							<tr>
								<th>작성일자</th>
								<td colspan="2">${onefreeboard.b_regdate }</td>
							</tr>
							<tr>
