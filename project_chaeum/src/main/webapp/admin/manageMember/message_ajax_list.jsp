...
<c:forEach var="tmp" items="${list }">
	<div class="chat_list_box${tmp.room } chat_list_box">
		<div type="button" class="chat_list" room="${tmp.room }" other-email="${tmp.other_email }">
			<!-- active-chat -->
			<div class="chat_people">
					<div class="chat_img">
						<a href="memberOne.do?other_email=${tmp.other_email }">
						</a>
					</div>
				</div>
				<div class="chat_ib">
					<h5>${tmp.other_email }<span class="chat_date">${tmp.send_time }</span>
					</h5>
					<div class="row">
						<div class="col-10">
							<p>${tmp.content }</p>
